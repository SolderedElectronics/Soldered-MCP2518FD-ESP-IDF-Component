/**
 * @file main.c
 * @brief Example for receiving frames over CAN using the CAN FD protocol and an interrupt
 *
...
static const char *TAG = "CANFD_RECV_INT";
...
void app_main(void)
{
    ...
    uint8_t buf[MAX_DATA_SIZE]; // Buffer to store the data
